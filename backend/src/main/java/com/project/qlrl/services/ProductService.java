...
public class ProductService {
    ...
    public Map<Object,Object> saveOrder(Map param){
        ...
        try {
            ...
            for (int i = 0; i < lstProduct.size(); i++) {
                ...
                productRepository.updateQuantityProduct(lstProduct.get(i));
            }
    ...
    public Map<Object,Object> getProductMng(Map<Object,Object> param){
        Map<Object, Object> result = new HashMap<>();
        try {
            result.put("data", productRepository.getProductMng(param));
        }catch (Exception e){
            e.printStackTrace();
            result.put("err", "err");
        }
