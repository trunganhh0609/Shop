...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 11, 2022 lúc 09:36 AM
...
(12, 1, 'gewgewgew', NULL, 'gwegwegweg', '2022-11-27 16:28:35', 'Nguyễn Trung Anh', '0123456789', 304000, b'1'),
(13, 1, 'jrytjyyjyj', NULL, 'jyyjyjjy', '2022-11-27 16:31:38', 'Nguyễn Trung Anh', '0123456789', 304000, b'0'),
(14, 1, 'gegegwe', NULL, 'geweggew', '2022-11-27 16:33:02', 'Nguyễn Trung Anh', '0123456789', 304000, b'0'),
(15, 1, 'evsdsd', NULL, 'vesbb', '2022-11-29 00:03:20', 'Nguyễn Trung Anh', '0123456789', 304000, b'0'),
(16, 2, 'dábdfngh', NULL, 'sdfncgvbn', '2022-12-02 23:29:30', 'Nguyễn Trung Anh', '12345678', 304000, b'0'),
...
(20, 'dwdw', 3, 1500000, 'Screenshot_14.png', 'fws', 1),
...
INSERT INTO `promotion` (`PROMOTION_ID`, `PROMOTION_KEY`, `PROMOTION_NAME`, `VALUE`, `START_DATE`, `END_DATE`) VALUES
(1, 'BLF001', 'Black Friday', 20, '2022-11-21 17:13:48', '2023-11-26 17:14:01'),
(2, 'S053', 'Sale', 19, '2023-11-05 17:00:00', '2023-12-28 17:00:00'),
(3, 'SS4212', 'Siêu Sale', 25, '2024-09-04 17:00:00', '2023-12-04 17:00:00'),
(4, 'tete', 'tet', 32, '2022-12-02 17:00:00', '2023-11-30 17:00:00'),
(6, 'GSGG', 'sale123', 14, '2023-12-03 17:00:00', '2023-01-04 17:00:00'),
(8, 'QQQ', 'qqqq', 12, '2022-12-06 17:00:00', '2022-12-26 17:00:00');
...
(2, 'user', 'Nguyễn Trung Anh', '2024-02-10 17:00:00', 'trunganh669911@gmial.com', '$2a$10$dt57pi5QQYqPKxvXaBWK/ef6CrNiW93/KqZcw.IseOnclR8voEf5i', '1234567322', '0', b'1'),
...
--
ALTER TABLE `product_oder`
  ADD CONSTRAINT `FK_product_oder_order` FOREIGN KEY (`ORDER_ID`) REFERENCES `order` (`ORDER_ID`),
